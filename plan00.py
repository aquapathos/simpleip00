...
def cv2q4pixmap(cv2img):
    ...
    print height,width,dim,bytesPerLine
...
def main():
    ...
    layout.addWidget(Pane01(parent=panels))
    layout.addWidget(Pane02(parent=panels))
    
    # メインパネルにレイアウトしたものを貼り付ける
    mainPanels.setLayout(layout)    
    # メインパネルをウィンドウ中央エリアに取り付け
    mainWindow.setCentralWidget(panels)
